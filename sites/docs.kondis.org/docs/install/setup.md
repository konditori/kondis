...
For automated provisioning, set `KONDIS_SETUP_TOKEN` to a secret containing 32-512 characters before the first startup. Generate one with `openssl rand -hex 32`; do not commit it or pass it as a command-line argument.
