...
The developer documentation consists of two parts: the main markdown files for the documentation which live in docs/dev, and then the API reference documentation autogenerated from the server code.
