...
export type { ActivityCommentEvent } from 'src/contracts/realtime.repository';
...
export class PostgresRealtimeRepository extends RealtimeRepository {
  private readonly logger = new Logger(PostgresRealtimeRepository.name);
