import { ConfigRepository } from 'src/contracts/config.repository';
...
export class EnvConfigRepository extends ConfigRepository {
  private readonly logger = new Logger(EnvConfigRepository.name);
