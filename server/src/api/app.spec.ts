...
const expectedOperations = [
  ...
  'GET /live-activities LiveActivityController_list',
  'POST /live-activities LiveActivityController_create',
  'GET /live-activities/shared/{token} LiveActivityController_getShared',
  'GET /live-activities/{id} LiveActivityController_get',
  'PATCH /live-activities/{id} LiveActivityController_update',
  'DELETE /live-activities/{id} LiveActivityController_discard',
  'POST /live-activities/{id}/points LiveActivityController_points',
  'POST /live-activities/{id}/share LiveActivityController_share',
  'DELETE /live-activities/{id}/share LiveActivityController_revokeShare',
