...
export const DEMO_ACTIVITIES: readonly DemoActivity[] = [
  ...
  },
  {
    ...
    comments: [
      ...
      { userId: LUCAS_USER_ID, body: 'Beauty ride, bud. The mountains are showing off harder than a Vancouver dad in Gore-Tex.' },
    ],
    likes: [JOHN_USER_ID, MARCUS_USER_ID],
  },
  {
  ...
  },
  {
    ...
    route: london,
    comments: [
      { userId: OSCAR_USER_ID, body: 'London is dangerously close to making cycling look fun.' },
    ],
    likes: [JOHN_USER_ID, SOFIA_USER_ID],
  },
  {
