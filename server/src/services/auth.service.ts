...
export class AuthService {
  ...
  async setup(email: string, name: string, password: string) { if (!(await this.setupStatus()).setupRequired) throw new ConflictException('Initial admin already exists'); return this.issue(await this.create(email, name, password, 'admin'), true); }
