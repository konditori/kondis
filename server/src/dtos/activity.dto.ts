...
export const ActivitySchema = z
  .object({
    ...
    excludeFromBestEfforts: z.boolean().describe('Exclude from best-effort rankings'),
...
export const ActivityUpdateSchema = z
  .object({
    ...
    excludeFromBestEfforts: z.boolean().optional().describe('Exclude from best-effort rankings'),
