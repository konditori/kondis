...
export const truncateAllTables = async (db: KondisDatabase): Promise<void> => {
  await sql`
    TRUNCATE TABLE auth_ticket, auth_session, auth_rate_limit, auth_bootstrap, takeout_import, live_workout_point, live_workout, activity_route_match, activity_stream, activity_best_effort, activity_metric, lap, activity, upload
