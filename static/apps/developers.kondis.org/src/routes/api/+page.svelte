...
<div class="page-shell">
  <section class="hero">
    ...
    <div class="hero-actions">
      <a class="button" href="/api/endpoints">Explore endpoints</a>
      <a class="button secondary" href="/api/sdk">Use the TypeScript SDK</a>
    </div>
  </section>
  ...
  <div class="next-grid">
    <a class="next-card" href="/api/introduction">
      <small>Start here</small>
      <strong>Understand the API conventions</strong>
    </a>
    <a class="next-card" href="/api/models">
