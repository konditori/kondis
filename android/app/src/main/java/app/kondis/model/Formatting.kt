...
fun sportLabel(sport: String): String = sport
    .replace('_', ' ')
    .split(' ')
...
fun formatElevation(meters: Double?, units: UnitSystem): String = when {
    meters == null -> "—"
...
fun formatPace(metersPerSecond: Double?, units: UnitSystem, swim: Boolean = false): String {
...
fun formatSpeed(metersPerSecond: Double?, units: UnitSystem): String {
...
fun formatDateTime(instant: String): String = runCatching {
